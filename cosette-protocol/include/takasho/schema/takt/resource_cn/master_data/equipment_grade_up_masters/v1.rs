...
pub struct EquipmentGradeUpMaster {
    #[prost(string, tag = "1")]
    pub master_version: ::prost::alloc::string::String,
    #[prost(int64, tag = "2")]
    pub equipment_grade_up_master_id: i64,
    #[prost(int64, tag = "3")]
...
#[allow(clippy::derive_partial_eq_without_eq)]
#[derive(Clone, PartialEq, ::prost::Message)]
pub struct EquipmentGradeUpMasters {
    #[prost(message, repeated, tag = "1")]
    pub equipment_grade_up_masters: ::prost::alloc::vec::Vec<EquipmentGradeUpMaster>,
}
